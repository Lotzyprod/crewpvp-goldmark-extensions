...
// SpoilerAttributeFilter defines attribute names which dd elements can have.
...
// Spoiler is an extension that allow you to use spoiler expression like '||text||' .
var Spoiler = &spoiler{}
